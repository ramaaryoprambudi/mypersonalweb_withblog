...
$stmt->bind_param("i", $id); // Bind the parameter as integer ('i')
$stmt->execute();
	...
	<div class="container mt-5">
		<div class="row justify-content-md-center">
			<div class="col-lg-8 mt-5">
				...
				<div class="mt-3 mb-3">
					<h2>
						<?= $parsedown->text(htmlspecialchars($data['judul'])); ?>
					</h2>
				</div>
				<?php
				$tags = htmlspecialchars($data['tag']);
				$tag = explode(" ", htmlspecialchars($tags));
				foreach ($tag as $t) :
				?>
				...
				<div class="mt-3">
					<?= $parsedown->text(htmlspecialchars($data['konten'])); ?>
				</div>
