...
<body class="<?= getDefaultTheme(); ?>">
    ...
    <div class="d-flex justify-content-center mb-5">
        <div class="mt-5">
            ...
            <!-- Rate limit warning -->
            <?php if (isset($login['error']) && $login['pesan'] === 'Too many login attempts. Please try again after 15 minutes.') : ?>
            ...
            <form class="rounded pt-2" method="post">
                ...
                <div class="mb-3 password-field input-wrapper">
                    ...
                    <span id="togglePassword" class="text-muted">
                        <i class="fas fa-eye input-icon" id="iconTogglePassword" style="cursor: pointer"></i>
                    </span>
                </div>
                
                 <!-- Tambahkan reCAPTCHA v2 -->
      <div class="mb-3">
        <div class="g-recaptcha" data-sitekey="6LdjQq8qAAAAAIRNlR0zQRLH_StpGLxck920VHlh"></div>
    </div>
