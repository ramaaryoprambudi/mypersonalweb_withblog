    ...
    <div class="row">
        ...
        <form onsubmit="return submitForm(this);" action="" class="mt-4" method="POST" enctype="multipart/form-data">
          <?php if (isset($preview)) : ?>
            <div class="judul mb-4">
              ...
              <textarea type="text" class="form-control bg-dark text-white" name="judul"><?= htmlspecialchars($preview['judul']); ?></textarea>
              <div>
                <blockquote>
                  <p class="fw-bold">
            ...
            <div class="tags mb-4">
              ...
              <textarea type="text" class="form-control bg-dark text-white" name="tags"><?= htmlspecialchars($preview['tags']); ?></textarea>
              <div>
                <blockquote>
                  <p class="fw-bold">
            ...
            <div class="konten mb-4">
              ...
              <textarea class="form-control bg-dark text-white" rows="35" placeholder="Something Text here . . ." name="konten"><?= htmlspecialchars($preview['konten']); ?></textarea>
              <div>
                <blockquote>
                  <p class="fw-bold">
      ...
      <div class="col-lg">
        ...
        <div class="container mt-4">
          <?php if (isset($preview)) : ?>
            <h2><?= $parsedown->text(htmlspecialchars($preview['judul'])); ?></h2>
            <?php
              $tags = $preview["tags"];
              $tag = explode(" ", $tags);
              foreach($tag as $t) :
            ?>
              <span class="tag"><i class="fas fa-tags me-1"></i> <?= htmlspecialchars($t); ?></span>
            <?php endforeach; ?>
            <br>
            <?= $parsedown->text(htmlspecialchars($preview['konten'])); ?>
          <?php endif; ?>
        </div>
      </div>
    </div>
